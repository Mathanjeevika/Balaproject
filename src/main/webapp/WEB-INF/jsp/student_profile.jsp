...
<!-- Normalize CSS -->
<link rel="stylesheet" href="plugincss/normalize.css">
<!-- Main CSS -->
<link rel="stylesheet" href="plugincss/main.css">
<!-- Bootstrap CSS -->
<link rel="stylesheet" href="plugincss/bootstrap.min.css">
<!-- Fontawesome CSS -->
<link rel="stylesheet" href="plugincss/all.min.css">
<!-- Flaticon CSS -->
<link rel="stylesheet" href="customcss/fontawesome/css/all.min.css">
<!-- Animate CSS -->
<link rel="stylesheet" href="plugincss/animate.min.css">
<!-- Select 2 CSS -->
<link rel="stylesheet" href="plugincss/select2.min.css">
<!-- Date Picker CSS -->
<link rel="stylesheet" href="plugincss/datepicker.min.css">
<!-- Custom CSS -->
<link rel="stylesheet" href="plugincss/style.css">

<link rel="stylesheet" href="customcss/custom.css">


<!-- Modernize js -->
<script src="pluginjs/modernizr-3.6.0.min.js"></script>
</head>
...
<body>
							...
							<div class="item-content">
								<ul class="settings-list">
									...
									<li><a href="#"><i class="flaticon-gear-loading"></i>Account
											Settings</a></li>
									<li><a href="login.html"><i class="flaticon-turn-off"></i>Log
											Out</a></li>
								</ul>
							</div>
						</div></li>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<form id="student-save" name="student-save"
									...
									<div class="row">
										...
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Gender *</label> <select class="select2" name="gender"
												id="gender">
										...
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Father's Name</label> <input type="text"
												name="fatherName" id="fatherName" placeholder=""
												class="form-control">
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Mother's Name</label> <input type="text"
												name="motherName" id="motherName" placeholder=""
												class="form-control">
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Date Of Birth *</label> <input type="text"
												name="dateOfBirth" id="dateOfBirth" placeholder="dd/mm/yyyy"
												class="form-control air-datepicker"
												data-position='bottom right'><i
												class="fas fa-calendar-week"></i>
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Religion *</label> <select class="select2"
										...
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>E-Mail</label> <input type="email" name="mail"
												id="mail" placeholder="" class="form-control">
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Phone</label> <input type="number" name="mobilePhone"
												id="mobilePhone" placeholder="" class="form-control">
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Father's Phone</label> <input type="number"
												placeholder="" class="form-control" name="fathersPhone"
												id="fathersPhone">
										</div>
										<div class="col-xl-3 col-lg-6 col-12 form-group">
											<label>Mother's Phone</label> <input type="number"
												placeholder="" class="form-control" name="mothersPhone"
												id="mothersPhone">
										</div>

										<div class="col-lg-6 col-12 form-group">
											<label>Adress *</label>
											<textarea class="textarea form-control" name="address"
												id="address" cols="10" rows="4"></textarea>
										</div>
							...
							<div class="single-info-details">
								...
								<div class="item-content">
									...
									<p>Aliquam erat volutpat. Curabiene natis massa sedde lacu
										...
										natis massa sedde sodale word moun taiery.</p>
									<div class="info-table table-responsive">
										<table class="table text-nowrap">
											<tbody>
												<tr>
													<td>Name:</td>
													<td class="font-medium text-dark-medium"><span id="sFirstName"></span></td>
												</tr>
												<tr>
													<td>Gender:</td>
													<td class="font-medium text-dark-medium"><span id="sGender"></span></td>
												</tr>
												<tr>
													<td>Father Name:</td>
													<td class="font-medium text-dark-medium"><span id="sFatherName"></span></td>
												</tr>
												<tr>
													<td>Mother Name:</td>
													<td class="font-medium text-dark-medium"><span id="sMotherName"></span></td>
												</tr>
												<tr>
													<td>Date Of Birth:</td>
													<td class="font-medium text-dark-medium"><span id="sDataofBirth"></span></td>
												</tr>
												<tr>
													<td>Religion:</td>
													<td class="font-medium text-dark-medium"><span id="sReligion"></span></td>
												</tr>
											
												<tr>
													<td>E-mail:</td>
													<td class="font-medium text-dark-medium"><span id="sMail"></span></td>
												</tr>
												
												<tr>
													<td>Roll:</td>
													<td class="font-medium text-dark-medium"><span id="sRollNmber"></span></td>
												</tr>
												<tr>
													<td>Address:</td>
													<td class="font-medium text-dark-medium"><span id="sAddress"></span></td>
												</tr>
												<tr>
													<td>Phone:</td>
													<td class="font-medium text-dark-medium"><span id="sPhone"></span></td>
												</tr>
											</tbody>
										</table>
									</div>
	...
	<!-- jquery-->
	<script src="pluginjs/jquery-3.3.1.min.js"></script>
	<script src="pluginjs/jquery-validation/jquery.validate.min.js"></script>
	<!-- Plugins js -->
	<script src="pluginjs/plugins.js"></script>
	<!-- Popper js -->
	<script src="pluginjs/popper.min.js"></script>
	<!-- Bootstrap js -->
	<script src="pluginjs/bootstrap.min.js"></script>
	<!-- Scroll Up Js -->
	<script src="pluginjs/jquery.scrollUp.min.js"></script>
	<!-- Select 2 Js -->
	<script src="pluginjs/select2.min.js"></script>
	<!-- Date Picker Js -->
	<script src="pluginjs/datepicker.min.js"></script>
	<!-- Custom Js -->
	<script src="pluginjs/main.js"></script>
	<script src="customjs/add-student.js"></script>
